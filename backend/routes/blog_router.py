...
from models import CreateBlogModel, CurrentUser, PaginatedBlogs, CreateCommentModel
...
def get_blogs(
    db: db_dependency, cursor: datetime | None = None, limit: int = 10, search: str = ""
):
    return blog_service.get_blogs(cursor, limit, search, db)
